...
?>
	<main class="main-content">
		<div class="row main-content__series" v-if="posts.length != 0">
			<div class="col s12 m6" v-for="(item, index) in posts">
				<div class="card">
					<div class="card-image">
						...
						<a :href="'<?php echo home_url('/'); ?>catalogo?id=' + item.imdbID" class="btn-floating btn-large halfway-fab waves-effect waves-light blue">
